                ...
                <div className="tw-flex tw-flex-1 tw-flex-col-reverse md:tw-flex-row tw-mx-auto tw-gap-8 tw-justify-between">
                  <div className="tw-flex tw-flex-col tw-gap-4 tw-flex-grow md:tw-max-w-[40%]">
                        ...
                        <div className="tw-text-pink-primary fs-12px tw-h-fit-content tw-my-auto tw-border tw-border-solid tw-border-pink-primary tw-rounded-md tw-px-2 tw-py-1 tw-w-fit-content tw-tracking-widest">
                          ESCROW 1d
                                                        ...
                                                        <div className="tw-border tw-border-solid tw-border-purple-1 tw-p-2 tw-rounded-md tw-text-white-1 tw-h-fit-content tw-text-[14px] tw-flex tw-gap-2 tw-whitespace-nowrap">
                                                            ...
                                                            <span className="tw-font-bold">8400 ◎</span>
                                                        </div>
                    ...
                    <p className="tw-mb-4 tw-text-gray-light">
                                                        A collection of 8,400 Stoned Frogs coming to
                                                        grow $SEEDS and take over the cannabis world.
                                                        Ribbit!
                    </p>
                    ...
                    <div className="tw-w-full">
                      <div className="tw-flex tw-flex-col tw-gap-1 tw-flex-grow 3xl:tw-hidden">
                        <div className="tw-flex tw-items-center tw-justify-between tw-text-[14px] tw-text-gray-5">
                          ...
                          <span>
                            <b className="tw-text-white-1">93%</b> (7812/8400)
                          </span>
                        </div>
                    ...
                    <div className="tw-flex tw-flex-col tw-gap-4 tw-flex-grow md:tw-w-[40%]">
                      ...
                      <div>
                        ...
                        <p className="tw-text-gray-light tw-mb-3 tw-text-[16] tx-line-[24]">
                                                                The Stoned Frogs aims to become the premier
                                                                Cannabis brand and manufacturer on the Solana
                                                                blockchain. Our ultimate objective is to create
                                                                in-person cannabis coffee shops all over the
                                                                world while joining the fight for the legalisation
                                                                of marijuana. Mimicking the coffeeshop is an
                                                                online store that offers CBD products and
                                                                merchandise to our global community.
                                                                Holder benefits are immense. The coffee shop offers
                                                                a revenue-sharing system for holders, based on
                                                                the amount of NFTs staked. In addition,
                                                                holders receive discounts on the online shop items.
                                                                To ensure that the coffee shop and online shop
                                                                are properly operating, we will be creating a
                                                                Stoned Frogs Cannabis farm that will act as a
                                                                warehouse for the creation, organization and
                                                                distribution of Cannabis Products,
                                                                Merchandise and other relevant resources.

                                                                In addition to our initiatives in the Cannabis space,
                                                                we have planned for additional engagement ventures
                                                                with our community. We will be hosting in-person
                                                                Reefer Parties for holders and giving away Mystery
                                                                Boxes for cash prizes. We are creating The Stoned
                                                                Frogs Game, which offers a play-to-earn opportunity
                                                                for holders. There is also an online deathmatch feature
                                                                built-into the game, which creates a burning mechanism
                                                                for $SEEDS. $SEEDS is our utility token, which will be used
                                                                to purchase products at the in-person or online shop,
                                                                betting in The Stoned Frogs Game, and much more.
                                                                Holders will be able to stake their NFTs to earn $SEEDS daily.
                                                                We will be contributing $SEEDS to charitable organizations
                                                                as well as cannabis organizations joining the
                    ...
                    <div className="tw-flex tw-flex-col tw-gap-4 tw-flex-grow md:tw-w-[50%]">
                      ...
                      <div className="tw-p-4">
                        <div className="tw-p-4">
                          ...
                          <div className="tw-my-1">
                            <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        Building a strong and active community to ensure the project’s
                                                                        success.
                          ...
                          <div className="tw-my-1">
                            <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        Come test your luck after the sell out. We will have a mystery
                                                                        box containing $100,000 worth of prizes. By owning a frog, you
                                                                        will automatically join the game. The more frogs you have, the
                          ...
                          <div className="tw-my-1">
                            <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        ...
                                                                        Stake your frogs to get daily earnings in $SEEDS. Staking will
                                                                        also automatically put you in one of the 3 colonies depending on
                                                                        the number of frogs you stake to earn a percentage of the
                                                                        coffee shop's profits.
                          ...
                          <div className="tw-my-1">
                            <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        The locations and times will be agreed/voted on by Holders and
                                                                        free to attend. The events will feature multiple competitions for
                                                                        prizes including strain tastings, create-your-own strain and
                                                                        much more.
                            </p>
                            <br />
                          </div>
                                                                ...
                                                                <div className="tw-my-1">
                                                                    <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        We will be creating an Online Store on our website to allow users
                                                                        to purchase products using $SEEDS which will include:


                                                                        Cannabis
                                                                        Cannabis Products—Ashtrays, Rolling Papers, Lighters, and more!
                                                                        CBD Products - Merchandise—T-Shirts, Hoodies, Hats, and more!
                                                                        Miscellaneous—Seasonal gifts and products!

                                                                        As a Stoned Frogs NFT holder, you will receive a discounted-
                                                                        price on all Online Store Items.
                                                                    </p>
                                                                    <br />
                                                                </div>
                                                                ...
                                                                <div className="tw-my-1">
                                                                    <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        Get immersed in the world of amphibians, the one they don't
                                                                        teach you about at school. Take a closer look into their natural
                                                                        habitat and discover the lives of your favorite interdimensional
                                                                        spirit animal, surviving the elements the only way they know how.


                                                                        Fight-to-Earn!

                                                                        The battles are the way frogs train and entertain themselves
                                                                        while awaiting the arrival of their sworn enemy, the dreaded
                                                                        lizards... Gather your friends, form a team, and battle it out
                                                                        in 3v3 co-op or 1v1 solo.

                                                                        Unranked Deathmatch: Climb your way to the top of the 3v3 or 1v1
                                                                        unranked leaderboards in free-to-play battles.
                                                                        Ranked Deathmatch: Think you're ready? Wager $SEEDS and
                                                                        compete in ranked 3v3 or 1v1 leaderboard battles..

                                                                        Winner takes 90% of $SEEDS that is wagered. The remaining
                                                                        10% of $SEEDS is burned.

                                                                        Tournaments with huge prizes will be held, so remember to keep
                                                                        an eye out to try and cement yourself as one of the big boys.

                                                                        Plant to earn!

                                                                        Plant your $SEEDS to grow into Cannabis Trees! Harvest the
                                                                        Cannabis Trees in time to gather additional $SEEDS. If you wait
                                                                        too long, the Cannabis Tree will dry up and all the $SEEDS will
                                                                        be lost!
                                                                ...
                                                                <div className="tw-my-1">
                                                                    <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        In order to ensure we have sufficient resources for our Stoned
                                                                        Frogs Coffee Shop we have formed a Legal Council team that will
                                                                        submit the necessary applications to European Countries
                                                                        that will allow us to grow and trade Marijuana.


                                                                        The purpose of The Stoned Frogs Farm is to act as a warehouse
                                                                        for the creation, organization and distribution of Cannabis
                                                                        Products, Merchandise and other relevant resources to
                                                                        the Stoned Frogs Coffeeshop.


                                                                        We will be working alongside the community to create our
                                                                        own, unique Stoned Frogs Strain of Cannabis!
                                                                ...
                                                                <div className="tw-my-1">
                                                                    <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        ...
                                                                        At the end of the journey, you will have made it to
                                                                        your destination, the sacred pond. The pond will be a
                                                                        real world cannabis coffee shop, where you will
                                                                        join your fellow members of the community in a real world
                                                                        setting. Share joints, stories, and profits of your
                                                                        journey together. Welcome to your new home, and nevertheless,
                                                                        don't forget to pass the joint.

                                                                        Stake your frogs to enter into one of the 3 colonies.
